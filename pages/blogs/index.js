...
const Blogs = ({
  ...
  const head = () => (
    <Head>
      <title>Naresh Blogs | {APP_NAME}</title>
      <meta name="description" content="Blogs by Naresh Chauhan" />
      <link rel="canonical" href={`${DOMAIN}${router.pathname}`} />
      <meta property="og:title" content={`Latest naresh blogs | ${APP_NAME}`} />
      <meta property="og:description" content="Blogs by Naresh Chauhan" />
      ...
      <meta
        property="og:image"
        content={`${DOMAIN}/static/images/nakamagarage.jpg`}
      />
      <meta
